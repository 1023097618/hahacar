...
async def generate_frames(source_url: str, camera_id: str, db,liveStreamType: str = None):
    try:
        cap = None
    ...
    try:
        while True:
            ...
            if not camera_url:
                ...
                return
            try:
                async for frame in generate_frames(camera_url, camera_id, db,liveStreamType):
